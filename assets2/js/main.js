...
$(".clicked").click(function (event) {
  ...
  if ($(this).parent().prev().find("p").hasClass("activeBtn")) {
    $(this).parent().prev().find("p").removeClass("activeBtn");
    $(this).parent().prev().find("p").css("max-height", "0px");
    $(".serviceBox").css("height", "290px");
    $(this).text("More");
    $(".clicked").removeClass("promjeniIme");
  } else {
    $(".activeBtn").css("max-height", "0px");
    $(".serviceBox").css("height", "290px");
    $(".activeBtn").removeClass("activeBtn");
    if ($(".clicked").hasClass("promjeniIme")) {
      $(".promjeniIme").text("More");
      $(".clicked").removeClass("promjeniIme");
    }
    $(this).addClass("promjeniIme");
    $(this).parent().prev().find("p").addClass("activeBtn");
    $(this).parent().parent().css("height", "100%");
    // $(".serviceBox").css("height", "100%");
    var heightinside =
      $(this).parent().prev().find(".activeBtn").height() + 650;
    $(this)
      .parent()
      .prev()
      .find(".activeBtn")
